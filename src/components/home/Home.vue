  ...
  <el-container class="home-container">
    ...
    <el-container>
      ...
      <el-aside :width="collapse ? '65px' :'200px'">
        ...
        <el-menu background-color="#333744" text-color="#fff" active-text-color="#409EFF" :collapse='collapse' :collapse-transition='false' router :default-active="ActivePath">
          <!-- el-submenu 是一级菜单 -->
          <el-submenu :index="item.id + ''" v-for='(item ,i) in menus' :key='item.id' 
          :style="collapse ? 'width: 65px;' : 'width: 200px;'">
